...
export async function handleRegisterPlatform(
  ...
  const data = {
    ...
    "initiate_login_uri": "https://adrian-dialang-lti.ngrok.app/lti/login",
    "redirect_uris": ["https://adrian-dialang-lti.ngrok.app/lti"],
    "client_name": "Dialang",
    "logo_uri": "http://bogus.org/dialang.png",
    "jwks_uri": "https://adrian-dialang-lti.ngrok.app/lti/keys",
    ...
    "https://purl.imsglobal.org/spec/lti-tool-configuration": {
      "domain": "adrian-dialang-lti.ngrok.app",
      "description": "Test your language skills.",
      "target_link_uri": "https://adrian-dialang-lti.ngrok.app/lti",
      "custom_parameters": {
